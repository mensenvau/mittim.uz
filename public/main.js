...
var main = (function() {
    ...
    var configs = (function() {
        ...
        Singleton.defaultOptions = {
            ...
            is_root: true,
            type_delay: 5,
            IsLove: "Find out if he loves you/U sizni sevishni aniqlash.",
    ...
    var files = (function() {
        ...
        Singleton.defaultOptions = {
            "BizHaqimizda.txt": "It's just for those who didn't get their love, maybe even didn't have time to love.\nThe only thing that can help you is forgetting, and that 's not possible . \n\n  Bu faqat o 'z sevgisini olmagan,     ehtimol hatto sevishga ulgurmaganlar uchun.\nSizga yordam beradigan yagona narsa bu unutishdir va bu mumkin emas.",
            "Aloqa.txt": "bubiznihioya@gmail.com",
            "Telegram.txt": "https://t.me/mensenvau",
            "GitHub.txt": "https://github.com/mensenvau/mittim.uz"
        };
        return {
            getInstance: function(options) {
                instance === void 0 && (instance = new Singleton(options));
    ...
    var cmds = {
        ...
        IsLove: { value: "IsLove", help: configs.getInstance().IsLove },
        LoveTest: { value: "LoveTest", help: configs.getInstance().LoveTest },
        Finish: { value: "Finish", help: configs.getInstance().Finish },
        Start: { value: "Start", help: configs.getInstance().Start },
    };
    ...
    Terminal.prototype.handleCmd = function() {
        ...
        switch (cmdComponents[0]) {
            ...
            case cmds.SUDO.value:
                this.sudo();
                break;
            case cmds.IsLove.value:
                this.IsLove(cmdComponents[1] || "");
                break;
            case cmds.LoveTest.value:
                this.LoveTest(cmdComponents[1] || "", cmdComponents[2] || "");
                break;
            case cmds.Start.value:
                this.Start();
                break;
            case cmds.Finish.value:
                this.Finish();
                break;
            default:
    ...
    Terminal.prototype.IsLove = function(name) {
        let time = new Date().getTime()
        if (name == 'Marjona') return this.type("No. there is a guy :(", this.unlock.bind(this))
        if (time % 2 == 0) return this.type("Yes of course :)))", this.unlock.bind(this))
        return this.type("Maybe you should think about it!", this.unlock.bind(this))
    }

    Terminal.prototype.LoveTest = function(boy_name, girl_name) {
        let ans = new Date().getTime()
            // ans = ans + parseInt(boy_name) + 2 * parseInt(girl_name)
        return this.type("Your love test " + ans % 100 + "%", this.unlock.bind(this));
    }

    Terminal.prototype.Start = function() {
        return this.type(`<a href="https://thoughtcatalog.com/lorenzo-jensen-iii/2015/04/50-timeless-pieces-of-advice-about-love-relationships/">50 Timeless Pieces Of Advice About Love & Relationships</a>`, this.unlock.bind(this));
    }

    Terminal.prototype.Finish = function() {
        return this.type(`<a href="https://www.youtube.com/watch?v=_JO2ebHKheY"> WINTER SONATA OST Full Original Soundtrack </a>`, this.unlock.bind(this));
    }
